...
figuras = {
    "Cereza": os.path.join(BASE_DIR,"Cereza.png"),
    "Uvas": os.path.join(BASE_DIR,"Uvas.png"),
...
titulo = tk.Label(ventana,text="Selecciona una Fruta", font=("Arial",14))
titulo.pack(pady=10)
